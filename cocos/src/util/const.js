...
const_val.mark_tips_color = cc.color(255,255,0)
const_val.mark_key_color = cc.color(255, 164, 164)
...
const_val.CLUB_OP_DEMISE			= 15;// 转让俱乐部
const_val.CLUB_OP_PRODDUCE_DISMISS	= 16;// 处理 退房申请
// activity
