...
var RecordUI = UIBase.extend({
    ...
    update_record_title: function (recordInfo) {
        let round_result = recordInfo['round_result'];
        ...
        roomid_label.setString("No." + recordInfo["roomID"].toString() + " (" + switches.gameName + ")");
        let user_info_list = recordInfo["user_info_list"];
