...
var CreateRoomSnippet = UISnippet.extend({
	initUI:function(){
		...
		var chx_list = ["game_mode_chx","player_num_chx","round_chx","max_lose_chx","treasure_chx","discard_seconds_chx", "pay_mode_chx"];
		var chx_label_list = ["game_mode_label_", "player_num_label_", "round_num_label_", "max_lose_num_label_", "treasure_num_label_", "discard_seconds_num_label_", "pay_mode_label_"];
		var chx_num_list = [2,3,3,4,3,3,2];
		var chx_func_list = [
		    function (i) {self.game_mode = i;},
            function (i) {self.player_num = 4-i;},
