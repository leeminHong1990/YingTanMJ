var LoginScene = cc.Scene.extend({
    ...
    onEnter: function () {
        ...
        if (switches.TEST_OPTION) {
            // cc.sys.localStorage.setItem("INFO_JSON", '{"unionid":"obEeHt0SUdbYxOUjhO7Hu93YVhIg","nickname":"Zachary","sex":1,"language":"zh_CN","city":"鹰潭","province":"鹰潭","country":"中国","headimgurl":"http:\/\/wx.qlogo.cn\/mmopen\/Q3auHgzwzM6zHFzbk0YyibNTMxxibJ2yhg2eq0sIBOgFHCKvSBsibkm2pjYVcwgjwsJlI4yrJvWzXBYHRohiced8tQ\/0","privilege":[]}');
