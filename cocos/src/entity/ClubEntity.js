...
var ClubEntity = KBEngine.Entity.extend({
    ctor : function(club_base_info)
    {
        ...
        this.dismiss_apply_list = club_base_info["dismiss_apply_list"];
        this.members = [];
    ...
    update_club_info:function (club_detail_info) {
        ...
        this.dismiss_apply_list = club_detail_info["dismiss_apply_list"];
    },
    ...
    get_base_info:function () {
        return {
            ...
            "owner" : this.owner,
            "dismiss_apply_list": this.dismiss_apply_list,
