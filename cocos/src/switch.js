...
if (typeof switchesnin1 === 'undefined' ) {
    ...
    switches.gzh_name = "棋牌汇";
    switches.contact_wx = "contact_wx";
    switches.contact_phone = "4001234567";
    switches.default_broadcast = "欢迎加入鹰潭麻将，鹰潭葫芦兄弟科技有限公司提供健康娱乐平台，严禁赌博！";

    switches.gameName = "鹰潭棋牌";
    switches.gameEngName = "ytmj";
    ...
    switches.customerService_wx = "customerService_wx";
